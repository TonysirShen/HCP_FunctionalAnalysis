function HCP_ComputeCorrelationProfile(seed_mesh, target, output_file1, output_file2,...
    threshold, varargin_file1, varargin_file2, outlier_text, split_data)

% CBIG(HCP*)_ComputeCorrelationProfile(seed_mesh, target, output_file1,...
...
%Modified by Social Mmeoy lab(Tony)
