...
allSubjs = readtable('/mnt/local_share/HCP/derivatives/cshen2/FilteredParticipants.xlsx')
fppDir = '/mnt/local_share/HCP/derivatives/fpp';
funcDir = [fppDir,'/func']
...
for t = 1:numel(tasks)
    ...
    for i=1:subjectlen
        ...
        inputPath = [funcDir,'/',allSubjs{i},'_task-workingmemory_run-01_space-fsLR_res-2_den-32k_desc-preproc_bold.dtseries.nii']
        for r = 1:runList
            %output path
            ...
            if ~exist(inputPath,'file') continue; end
